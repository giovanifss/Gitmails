...
flow_group.add_argument("-u", "--username", help="Username of the owner of the repositories")
flow_group.add_argument("-r", "--repository", help="Direct link to a specific repository")
...
print_group.add_argument("--raw", help="Print raw results separated by comma", action="store_true")
print_group.add_argument("--include-repositories", help="Print emails and repositories relation", action="store_true")
